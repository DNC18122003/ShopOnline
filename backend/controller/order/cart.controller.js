...
const addToCart = async (req, res) => {
    try {
        ...
        const normalizedType = productType.charAt(0).toUpperCase() +
       ...
       console.log("productId:", productId);
        ...
        if (quantity > 99) {
         ...
         const Model = getProductModel(normalizedType);
...
const updateCart = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Update to cart failed", error: error.message });
  }
};
