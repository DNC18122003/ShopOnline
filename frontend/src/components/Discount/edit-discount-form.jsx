...
export function EditDiscountForm({ initialData, onSubmit, onCancel, readOnly = false }) {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            maxDiscountValue:
                discountType === 'percentage' || discountType === 'percent' ? Number(maxDiscountValue) : 0,
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className={cn(
                                    'pl-8',
                                    errorMessage.includes('Giá trị giảm') || errorMessage.includes('Phần trăm')
                                        ? 'border-red-500'
                                        : '',
                                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {(formData.discountType === 'percentage' || formData.discountType === 'percent') && (
                        <div className="space-y-2 animate-in fade-in zoom-in-95 duration-200">
                            <Label>
                                Giá trị tối đa được giảm <span className="text-red-500">*</span>
                            </Label>
                            <div className="relative">
                    ...
                    <div className="space-y-2">
                        <Label>
                            Giới hạn sử dụng (Lượt) <span className="text-red-500">*</span>
                        </Label>
                        <Input
                            type="number"
                            value={formData.usageLimit}
                            className={cn(
                                errorMessage.includes('số lượt') || errorMessage.includes('Giới hạn')
                                    ? 'border-red-500'
                                    : '',
                            )}
                ...
                <div className="flex items-center space-x-2 bg-gray-50 p-3 rounded-lg border border-gray-100 w-fit">
                    <div className={readOnly ? 'pointer-events-none' : ''}>
                        <Switch
                            ...
                            disabled={false}
                            className={cn('data-[state=checked]:bg-blue-600', 'opacity-100')}
                        />
                    </div>
                    <Label
                        className={cn(
                            ...
                            <PopoverTrigger asChild disabled={readOnly}>
                                <Button
                                    ...
                                    className={cn(
                                        ...
                                        (errorMessage.includes('ngày kết thúc') || errorMessage.includes('quá khứ')) &&
