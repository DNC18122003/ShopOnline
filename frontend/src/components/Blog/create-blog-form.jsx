...
export function CreateBlogForm({ onSubmit, onCancel, currentUser }) {
    ...
    const isExcerptError =
        (errorText.includes('bắt buộc') && !formData.excerpt.trim()) || errorText.includes('Nội dung');
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    <div className="flex justify-between">
                        ...
                        <span
                            className={`text-[10px] ${formData.title.length > 50 ? 'text-red-500' : 'text-gray-400'}`}
                        >
                ...
                <div className="space-y-2">
                    <div className="flex justify-between">
                        ...
                        <span
                            className={`text-[10px] ${formData.excerpt.length > 500 ? 'text-red-500' : 'text-gray-400'}`}
                        >
