    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="w-full h-48 border rounded-lg bg-gray-50 overflow-hidden flex items-center justify-center">
          {blog.thumbnail ? (
            <img src={blog.thumbnail} alt={blog.title} className="w-full h-full object-contain bg-black/5" />
          ) : (
      ...
      <div className="space-y-2">
        ...
        <Input readOnly value={blog.title || ""} className="bg-gray-50 font-medium cursor-default focus-visible:ring-0" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-blue-50/50 p-4 rounded-lg border border-blue-100">
        <div className="space-y-1">
          <Label className="text-xs text-gray-500 flex items-center gap-1"><User className="w-3 h-3"/> Người tạo</Label>
        ...
        <div className="space-y-1">
          <Label className="text-xs text-gray-500 flex items-center gap-1"><Eye className="w-3 h-3"/> Lượt xem</Label>
        ...
        <div className="space-y-1">
          ...
          <div>
            <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
              blog.status === "published" ? "bg-green-100 text-green-700" : "bg-gray-200 text-gray-700"
            }`}>
