            ...
            <div className="max-w-2xl w-full text-center">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-lg text-slate-400 mb-12 text-balance">
                        Xin lỗi, trang bạn đang tìm kiếm không tồn tại hoặc đã bị xóa. Hãy quay lại trang chủ để tiếp
                        tục.
                    </p>
                    ...
                    <div className="mt-16 pt-8 border-t border-slate-700">
                        <p className="text-sm text-slate-500">Mã lỗi: 404 | Trang không tìm thấy</p>
                    </div>
                </div>
            </div>
        </div>
