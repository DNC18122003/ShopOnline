    ...
    return (
        <div className="w-full  flex items-center justify-center h-full">
            <div className="bg-white border w-100  mx-4 flex items-center justify-center flex-col p-5 rounded-md shadow-md gap-3">
                ...
                <Input type="password" placeholder="Mật khẩu hiện tại" name="currentPassword" onChange={handleChange} />
                ...
                />
                <Button className="w-full bg-blue-600 hover:bg-blue-700" onClick={handleSubmitForm} disabled={loading}>
                    Tiếp tục
                </Button>
            </div>
        </div>
